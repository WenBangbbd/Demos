...
namespace RabbitMQDemo.Consumer
{
    public static class Extensions
    {
        ...
        public static IModel BindQueToExchange(this IModel channel, string queName,string type, string routingKey, IDictionary<string, object> arguments)
        {
            channel.QueueBind(queName,type,routingKey, arguments);
            return channel;
        }
